...
class autenticaController extends Controller
{
    ...
    public function index()
    {
        ...
        if($cont>1)
        {
            return view ('Funcionario/autentica/index', compact('horarios','v2','cont'));
        }
        else
        {
            return view ('Funcionario/autentica/index', compact('horarios','cont'));
        }
        //return view ('Funcionario/horarios/index', compact('horarios')); 
    }
    ...
    public function edit($id,Request $request)
    {
        if($request->ajax()){
            ...
            if($cont>1)
            {
                return view ('Funcionario/autentica/edit',compact('rut','horarios','salas','periodos','cursos','v2','cont'));
            }
            else
            {
                return view ('Funcionario/autentica/edit',compact('rut','horarios','salas','periodos','cursos','cont'));
            }

            //return view('Funcionario/horarios/edit',compact('horarios','salas','periodos','cursos'));
        }
    ...
    {   
        ...
        return redirect()->route('funcionario.autentica.index');
    }
