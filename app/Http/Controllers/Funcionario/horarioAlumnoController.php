    ...
    public function edit($id,Request $request)
    {
        if($request->ajax()){
         //dd($request);
            ...
            if($cont>1)
            {
                return view ('Funcionario/horariosAlum/edit',compact('horarios','salas','periodos','est','v2','cont'));
            }
            else
            {
                return view ('Funcionario/horariosAlum/edit',compact('horarios','salas','periodos','est','cont'));
            }
