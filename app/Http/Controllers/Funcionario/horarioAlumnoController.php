...
class horarioAlumnoController extends Controller
{
    ...
    public function index()
    {
        ...
        if($cont>1)
        {
            return view ('Funcionario/horariosAlum/index', compact('horarios','v2','cont'));
        }
        else
        {
            return view ('Funcionario/horariosAlum/index', compact('horarios','cont'));
        }
        //return view ('Funcionario/horariosAlum/index', compact('horarios')); 
    }
    ...
    public function edit($id,Request $request)
    {
        if($request->ajax()){
            ...
            if($cont>1)
            {
                return view ('Funcionario/horariosAlum/edit',compact('rut','horarios','salas','periodos','est','v2','cont'));
            }
            else
            {
                return view ('Funcionario/horariosAlum/edit',compact('rut','horarios','salas','periodos','est','cont'));
            }
            //return view('Funcionario/horariosAlum/edit',compact('horarios','salas','periodos','est'));
        }
    }
