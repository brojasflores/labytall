...
class contactoController extends Controller
{
    ...
    {
        return view('Funcionario/contacto'); 
    }
    ...
    {
        $usuario = User::all();
        return view ('Funcionario/correo', compact('usuario'));
    }
    ...
    public function store(Request $request)
    {
        ...
        if($request->get('tipo')=='contactenos')
        {
            ...
            return Redirect::to('funcionario/contacto');
        }
        else
        {
            ...
            return redirect()->route('funcionario.contacto.create');
        }
    }
