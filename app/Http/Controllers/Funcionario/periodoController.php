...
class periodoController extends Controller
{
    ...
    public function index()
    {
        ...
        if($cont>1)
        {
            return view ('Funcionario/periodos/index', compact('periodos','v2','cont'));
        }
        else
        {
            return view ('Funcionario/periodos/index', compact('periodos','cont'));
        }
        //return view ('Funcionario/periodos/index', compact('periodos'));
    }
    ...
    public function create()
    {
        ...
        if($cont>1)
        {
            return view ('Funcionario/periodos/create', compact('v2','cont'));
        }
        else
        {
            return view ('Funcionario/periodos/create', compact('cont'));
        }
        //return view('Funcionario/periodos/create');
    }
    ...
    public function store(Request $request)
    {
        ...
        if($fecha == 'nook')
        {
            ...
            return redirect()->route('funcionario.periodo.create');
        }
        else
        {
            ...
            return redirect()->route('funcionario.periodo.index');
        }
    }
    ...
    public function edit($id)
    {
        ...
        if($cont>1)
        {
            return view ('Funcionario/periodos/edit', compact('inicio','fin','periodos','v2','cont'));
        }
        else
        {
            return view ('Funcionario/periodos/edit', compact('inicio','fin','periodos','cont'));
        }
        //return view('Funcionario/periodos/edit', compact('periodos'));
    }
