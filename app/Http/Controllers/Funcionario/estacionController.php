...
class estacionController extends Controller
{
    ...
    public function index()
    {
        ...
        if($cont>1)
        {
            return view ('Funcionario/estacion/index', compact('estaciones','v2','cont'));
        }
        else
        {
            return view ('Funcionario/estacion/index', compact('estaciones','cont'));
        }
    }
    ...
    public function edit($id)
    {
        ...
        if($cont>1)
        {
            return view ('Funcionario/estacion/edit', compact('est','v2','cont'));
        }
        else
        {
            return view ('Funcionario/estacion/edit', compact('est','cont'));
        }
    }
    ...
    public function update(Request $request, $id)
    {
        ...
        return redirect()->route('funcionario.estacion.index');
    }
