...
class horarioController extends Controller
{
    ...
    public function index()
    {
        ...
        if($cont>1)
        {
            return view ('Director/horarios/index', compact('horarios','v2','cont'));
        }
        else
        {
            return view ('Director/horarios/index', compact('horarios','cont'));
        }
        //return view ('Director/horarios/index', compact('horarios')); 
    }
    ...
    public function edit($id,Request $request)
    {
        if($request->ajax()){
            ...
            if($cont>1)
            {
                return view ('Director/horarios/edit',compact('rut','horarios','salas','periodos','cursos','v2','cont'));
            }
            else
            {
                return view ('Director/horarios/edit',compact('rut','horarios','salas','periodos','cursos','cont'));
            }

            //return view('Director/horarios/edit',compact('horarios','salas','periodos','cursos'));
        }
