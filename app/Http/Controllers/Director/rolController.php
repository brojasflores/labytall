...
class rolController extends Controller
{
    ...
    public function index()
    {
        ...
        if($cont>1)
        {
            return view ('Director/roles/index', compact('roles','v2','cont'));
        }
        else
        {
            return view ('Director/roles/index', compact('roles','cont'));
        }
    ...
    public function create()
    {
        ...
        if($cont>1)
        {
            return view ('Director/roles/create', compact('v2','cont'));
        }
        else
        {
            return view ('Director/roles/create', compact('cont'));
        }
    ...
    public function store(Request $request)
    {
        ...
        return redirect()->route('director.rol.index');
    }
    ...
    public function edit($id)
    {
        ...
        if($cont>1)
        {
            return view ('Director/roles/edit', compact('roles','v2','cont'));
        }
        else
        {
            return view ('Director/roles/edit', compact('roles','cont'));
        }
