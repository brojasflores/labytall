...
class autenticaController extends Controller
{
    ...
    public function index()
    {
        ...
        if($cont>1)
        {
            return view ('Director/autentica/index', compact('horarios','v2','cont'));
        }
        else
        {
            return view ('Director/autentica/index', compact('horarios','cont'));
        } 
    }
    ...
    public function edit($id,Request $request)
    {
        if($request->ajax()){
            ...
            if($cont>1)
            {
                return view ('Director/autentica/edit',compact('rut','horarios','salas','periodos','cursos','v2','cont'));
            }
            else
            {
                return view ('Director/autentica/edit',compact('rut','horarios','salas','periodos','cursos','cont'));
            }
    ...
    {   
        ...
        return redirect()->route('director.autentica.index');
