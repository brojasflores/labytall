...
class reportesController extends Controller
{
    ...
    public function RepUsr(Request $request)
    {
        ...
        if($cont>1)
        {
            return view ('Director/graficas/RepUsr',compact('sala','v2','cont'));
        }
        else
        {
            return view ('Director/graficas/RepUsr',compact('sala','cont'));
        }
    ...
    public function RepSa(Request $request)
    {
        ...
        if($cont>1)
        {
            return view ('Director/graficas/RepSa',compact('sala','v2','cont'));
        }
        else
        {
            return view ('Director/graficas/RepSa',compact('sala','cont'));
        }
    ...
    public function RepAsig(Request $request)
    {
        ...
        if($cont>1)
        {
            return view ('Director/graficas/RepAsig',compact('asignatura','v2','cont'));
        }
        else
        {
            return view ('Director/graficas/RepAsig',compact('asignatura','cont'));
        }
    ...
    public function RepFall(Request $request)
    {
        ...
        if($cont>1)
        {
            return view ('Director/graficas/RepFall',compact('sala','v2','cont'));
        }
        else
        {
            return view ('Director/graficas/RepFall',compact('sala','cont'));
        }
