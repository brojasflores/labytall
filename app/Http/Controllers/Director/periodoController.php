...
class periodoController extends Controller
{
    ...
    public function index()
    {
        ...
        if($cont>1)
        {
            return view ('Director/periodos/index', compact('periodos','v2','cont'));
        }
        else
        {
            return view ('Director/periodos/index', compact('periodos','cont'));
        }
        //return view ('Director/periodos/index', compact('periodos'));
    }
    ...
    public function create()
    {
        ...
        if($cont>1)
        {
            return view ('Director/periodos/create', compact('v2','cont'));
        }
        else
        {
            return view ('Director/periodos/create', compact('cont'));
        }
        //return view('Director/periodos/create');
    }
    ...
    public function store(Request $request)
    {
        ...
        if($fecha == 'nook')
        {
            ...
            return redirect()->route('director.periodo.create');
        }
        else
        {
    ...
    public function edit($id)
    {
        ...
        if($cont>1)
        {
            return view ('Director/periodos/edit', compact('inicio','fin','periodos','v2','cont'));
        }
        else
        {
            return view ('Director/periodos/edit', compact('inicio','fin','periodos','cont'));
        }
        //return view('Director/periodos/edit', compact('periodos'));
    }
