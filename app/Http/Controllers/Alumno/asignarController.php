...
class asignarController extends Controller
{
    ...
    public function docente()
    {
        ...
        if($cont>1)
        {
            return view ('Alumno/asignar/docente',compact('salas','periodos','cursos','v2','cont'));
        }
        else
        {
            return view ('Alumno/asignar/docente',compact('salas','periodos','cursos','cont'));
        }
    ...
    public function Alumno()
    {
        ...
        if($cont>1)
        {
            return view ('Alumno/asignar/ayudante',compact('salas','periodos','cursos','v2','cont'));
        }
        else
        {
            return view ('Alumno/asignar/ayudante',compact('salas','periodos','cursos','cont'));
        }
    ...
    public function alumno()
    {
        ...
        if($cont>1)
        {
            return view ('Alumno/asignar/alumno',compact('salas','periodos','cursos','capacidad','v2','cont'));
        }
        else
        {
            return view ('Alumno/asignar/alumno',compact('salas','periodos','cursos','capacidad','cont'));
        }
