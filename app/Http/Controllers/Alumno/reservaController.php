...
class reservaController extends Controller
{
   public function __construct()
    ...
    public function index()
    {
        ...
        if($cont>1)
        {
            return view ('Alumno/horariosAlumP/index', compact('horarios','v2','cont'));
        }
        else
        {
            return view ('Alumno/horariosAlumP/index', compact('horarios','cont'));
        }
    ...
    public function edit($id,Request $request)
    {
        if($request->ajax()){
            ...
            if($cont>1)
            {
                return view ('Alumno/horariosAlumP/edit',compact('horarios','salas','periodos','est','v2','cont'));
            }
            else
            {
                return view ('Alumno/horariosAlumP/edit',compact('horarios','salas','periodos','est','cont'));
            }
    ...
    {          
        ...
        if($request->get('fecha')==null)
        {
            ...
            return redirect()->route('alumno.MihorarioAlumno.index');
        }
