...
class asignaturaController extends Controller
{
    ...
    public function index()
    {
        ...
        return view ('Alumno/asignaturas/index', compact('asignaturas'));
    }
    ...
    {
        return view('Alumno/asignaturas/create');
    }
    ...
    public function store(Request $request)
    {
        $asignaturas = Asignatura::create([
            ...
            //$asignaturas = Asignatura::all();        
        return redirect()->route('alumno.asignatura.index');
    }
    ...
    public function edit($id)
    {
        ...
        return view('Alumno/asignaturas/edit', compact('asignaturas'));
    }
