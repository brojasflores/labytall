...
class rolController extends Controller
{
    ...
    public function index()
    {
        ...
        return view ('Alumno/roles/index', compact('roles'));
    }
    ...
    {
        return view('Alumno/roles/create');
    }
    ...
    public function store(Request $request)
    {
        ...
        return redirect()->route('alumno.rol.index');
    }
    ...
    public function edit($id)
    {
        ...
        return view('Alumno/roles/edit', compact('roles'));
    }
