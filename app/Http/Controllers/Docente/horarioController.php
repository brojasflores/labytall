...
class horarioController extends Controller
{
    ...
    public function edit($id,Request $request)
    {
        if($request->ajax()){
            ...
            if($cont>1)
            {
                return view ('Docente/horarios/edit',compact('rut','horarios','salas','periodos','cursos','v2','cont'));
            }
            else
            {
                return view ('Docente/horarios/edit',compact('rut','horarios','salas','periodos','cursos','cont'));
            }
