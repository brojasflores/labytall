...
class salaController extends Controller
{
    ...
    public function index()
    {
        ...
        return view ('Docente/salas/index', compact('salas'));
    }
    ...
    {
        return view('Docente/salas/create');
    }
    ...
    public function store(Request $request)
    {
        ...
        return redirect()->route('docente.sala.index');
    }
    ...
    public function edit($id)
    {
        ...
        return view('Docente/salas/edit', compact('sala'));
    }
