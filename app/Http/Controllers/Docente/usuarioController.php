...
class usuarioController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('Docente/usuarios/index', compact('usuarios')); 
    }
    ...
    {
        $roles = Rol::all();
        return view('Docente/usuarios/create',compact('roles'));
    }
    ...
    public function store(Request $request)
    {
       ...
       // $pass = Hash::make($request->get('rut'));
        ...
        return redirect()->route('docente.usuario.index');
    }
    ...
    public function edit($id,Request $request)
    {
        ...
        if($request->ajax()){
            ...
            return view('Docente/usuarios/edit', compact('usuario'));
        }
    }
    ...
    {
        return view('Docente/usuarios/perfil');
    }
