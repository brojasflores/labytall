...
class periodoController extends Controller
{
    ...
    public function index()
    {
        ...
        return view ('Ayudante/periodos/index', compact('periodos'));
    }
    ...
    {
        return view('Ayudante/periodos/create');
    }
    ...
    public function store(Request $request)
    {
        ...
        return redirect()->route('ayudante.periodo.index');
    }
    ...
    public function edit($id)
    {
        ...
        return view('Ayudante/periodos/edit', compact('periodos'));
    }
