...
class usuarioController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('Ayudante/usuarios/index', compact('usuarios')); 
    }
    ...
    {
        $roles = Rol::all();
        return view('Ayudante/usuarios/create',compact('roles'));
    }
    ...
    public function edit($id,Request $request)
    {
        ...
        if($request->ajax()){
            ...
            return view('Ayudante/usuarios/edit', compact('usuario'));
        }
    }
    ...
    {
        return view('Ayudante/usuarios/perfil');
    }
