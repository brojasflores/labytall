...
class salaController extends Controller
{
    ...
    public function index()
    {
        ...
        return view ('Ayudante/salas/index', compact('salas'));
    }
    ...
    {
        return view('Ayudante/salas/create');
    }
    ...
    public function store(Request $request)
    {
        ...
        return redirect()->route('ayudante.sala.index');
    }
    ...
    public function edit($id)
    {
        ...
        return view('Ayudante/salas/edit', compact('sala'));
    }
