...
class asignaturaController extends Controller
{
    ...
    public function index()
    {
        ...
        return view ('Ayudante/asignaturas/index', compact('asignaturas'));
    }
    ...
    {
        return view('Ayudante/asignaturas/create');
    }
    ...
    public function edit($id)
    {
        ...
        return view('Ayudante/asignaturas/edit', compact('asignaturas'));
    }
