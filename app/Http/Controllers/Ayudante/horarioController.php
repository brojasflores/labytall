...
class horarioController extends Controller
{
    ...
    public function index()
    {
        ...
        if($cont>1)
        {
            return view ('Ayudante/horarios/index', compact('horarios','v2','cont'));
        }
        else
        {
            return view ('Ayudante/horarios/index', compact('horarios','cont'));
        }
    ...
    public function edit($id,Request $request)
    {
        if($request->ajax()){
            ...
            if($cont>1)
            {
                return view ('Ayudante/horarios/edit',compact('rut','horarios','salas','periodos','cursos','v2','cont'));
            }
            else
            {
                return view ('Ayudante/horarios/edit',compact('rut','horarios','salas','periodos','cursos','cont'));
            }
