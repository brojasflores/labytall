...
class cursoController extends Controller
{
    ...
    public function index()
    {
        ...
        return view ('Ayudante/cursos/index', compact('cursos'));
    }
    ...
    public function create()
    {
        ...
        return view('Ayudante/cursos/create',compact('asignaturas'));
    }
    ...
    public function store(Request $request)
    {
        ...
        return redirect()->route('ayudante.curso.index');
    }
    ...
    public function edit($id)
    {
        ...
        $asignaturas = Asignatura::all();
        return view('Ayudante/cursos/edit', compact('cursos','asignaturas'));
    }
