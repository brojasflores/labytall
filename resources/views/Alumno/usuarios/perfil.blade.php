...
@stop
@section('opcion')
<li><a href="{{ route('alumno.usuario.index')}}"><i class="fa fa-user"></i> Usuarios</a></li>
...
<form  method='post' action='{{url("alumno/usuario_perfilUpdate")}}' enctype='multipart/form-data'>
  {{csrf_field()}}
    <div class="row">
	  	<div class="col-md-4">
