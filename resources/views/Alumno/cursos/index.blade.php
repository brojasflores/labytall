...
@section('content')
<h1>Cursos</h1>
<form role="form" method="get" action="{{ route('alumno.curso.create')}}">
        ...
        <div class="box-body">
          ...
          <!--foreach recorre una coleccion de objetos-->
              ...
              <tr data-id="{{ $cur->id }}">
                ...
                <td><a href="{{ route('alumno.curso.edit',$cur->id)}}"><button type="submit" class="fa fa-edit btn btn-edit"> Editar</button></a></td>
                <td>
                {!! Form::open(['route' => ['alumno.curso.destroy', $cur->id], 'method' => 'DELETE', 'id' => 'form-delete'])!!}
