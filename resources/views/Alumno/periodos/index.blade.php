...
@section('content')
<h1>Períodos</h1>
<form role="form" method="get" action="{{ route('alumno.periodo.create')}}">
        ...
        <div class="box-body">
          ...
          <!--foreach recorre una coleccion de objetos-->
              ...
              <tr data-id="{{ $per->id }}">
                ...
                <td><a href="{{ route('alumno.periodo.edit',$per->id)}}"><button type="submit" class="fa fa-edit btn btn-edit"> Editar</button></a></td>
                <td>
                {!! Form::open(['route' => ['alumno.periodo.destroy', $per->id], 'method' => 'DELETE', 'id' => 'form-delete'])!!}
