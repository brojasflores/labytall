...
@endif
<h1>Carreras</h1>
<form role="form" method="get" action="{{ route('director.carrera.create')}}">
          ...
          <div class="box-body">
            <table id="example1" class="table table-bordered table-striped">
              ...
              <tr data-id="{{ $ca->id }}">
                ...
                <td><a href="{{ route('director.carrera.edit',$ca->id)}}"><button type="submit" class="fa fa-edit btn btn-edit"> Editar</button></a></td>
                <td>
                {!! Form::open(['route' => ['director.carrera.destroy', $ca->id], 'method' => 'DELETE', 'id' => 'form-delete'])!!}
