...
@endif
<h1>Salas</h1>
<form role="form" method="get" action="{{ route('director.sala.create')}}">
          ...
          <div class="box-body">
            <table id="example1" class="table table-bordered table-striped">
              ...
              <tr data-id="{{ $sa->id }}">
                ...
                <td><a href="{{ route('director.sala.edit',$sa->id)}}"><button type="submit" class="fa fa-edit btn btn-edit"> Editar</button></a></td>
                <td>
                {!! Form::open(['route' => ['director.sala.destroy', $sa->id], 'method' => 'DELETE', 'id' => 'form-delete'])!!}
