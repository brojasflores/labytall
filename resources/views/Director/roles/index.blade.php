...
@endif
<h1>Roles</h1>
<form role="form" method="get" action="{{ route('director.rol.create')}}">
          ...
          <div class="box-body">
            <table id="example1" class="table table-bordered table-striped">
              ...
              <tr data-id="{{ $rol->id }}">
                ...
                <td><a href="{{ route('director.rol.edit',$rol->id)}}"><button type="submit" class="fa fa-edit btn btn-edit"> Editar</button></a></td>
                <td>
                {!! Form::open(['route' => ['director.rol.destroy', $rol->id], 'method' => 'DELETE', 'id' => 'form-delete'])!!}
