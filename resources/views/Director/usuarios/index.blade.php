...
@endif
<h1>Usuarios</h1>
<form role="form" method="get" action="{{ route('director.usuario.create')}}">
          ...
          <div class="box-body">
            <table id="example1" class="table table-bordered table-striped">
              ...
              <tr data-id="{{ $usr->id }}">
                ...
                <td><a href="{{ route('director.usuario.edit',$usr->id)}}"><button type="submit" class="fa fa-edit btn btn-edit"> Editar</button></a></td>
                <td>
                {!! Form::open(['route' => ['director.usuario.destroy', $usr->id], 'method' => 'DELETE', 'id' => 'form-delete'])!!}
