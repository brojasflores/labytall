...
<li class="dropdown user user-menu">
  ...
  <li class="dropdown user user-menu">
    <a>
    <form role="form" method="get" action="{{ route('director.formatos.download') }}">     
        <input type="hidden" name="_token" id="token" value="{{ csrf_token() }}">
        <img src="{{asset('admin-lte/dist/img/download.png')}}" class="user-image" alt="User Image">        
...
<ul class="sidebar-menu">
            ...
            <li class="treeview">
              ...
              <ul class="treeview-menu">
                ...
                <li><a href="{{ route('director.autentica.index')}}"><i class="fa fa-check-square"></i> Asistencia</a></li>
              </ul>
            </li>
            <li class="treeview">
              <a href="#">
...
@stop
@section('opcion')
<li><a href="{{ route('director.autentica.index')}}"><i class="fa fa-clock-o"></i> Asistencia</a></li>
...
{!! Form::model($horarios,['route' => ['director.autentica.update',$horarios], 'method' => 'PUT']) !!}
	    	...
	    	<div class="row">
	    		<div class="col-md-3">
					<div class="form-group">
					  ...
					  <select disabled="disabled" class="form-control" id="sala_id" name="sala_id">
	    	...
	    	<div class="row">
	    		<div class="col-md-3">
					<div class="form-group">
					  ...
					  <select disabled="disabled" class="form-control" id="permanencia" name="permanencia">
	    		...
	    		<div class="col-md-3" id="col-dia" style="display: none";>
					<div class="form-group">
					  <label for="sel1">Día: </label>
						<select disabled="disabled" class="form-control" id="dia" name="dia">
	    		...
	    		<div class="col-md-3" id="col-fecha-ini" style="display: none";>
					<div class="form-group">
					  <label for="sel1">Fecha Inicio: </label>
						  <input disabled="disabled" type="text" class="form-control" placeholder="Fecha" name="fecha_inicio" id="fecha_inicio" aria-describedby="basic-addon2">
					</div>
		    	</div>	
	    		<div class="col-md-3" id="col-fecha-fin" style="display: none";>
					<div class="form-group">
					  <label for="sel1">Fecha Fin: </label>
						  <input disabled="disabled" type="text" class="form-control" placeholder="Fecha" name="fecha_fin" id="fecha_fin" aria-describedby="basic-addon2">
					</div>
		    	</div>			    			    			    	
		    </div>
	    </div> 
	    	...
	    	<div class="row">
	    		<div class="col-md-3">
					<div class="form-group">
					  ...
					  <select disabled="disabled" class="form-control" id="periodo_id" name="periodo_id">
	    	...
	    	<div class="row">
	    		<div class="col-md-3">
					<div class="form-group">
					  ...
					  <select disabled="disabled" class="form-control" id="curso_id" name="curso_id">
	    	...
	    	<div class="row">
	    		<div class="col-md-3">
					<div class="form-group">
					  ...
					  <select disabled="disabled" class="form-control" id="rol" name="rol">
...
$(document).ready(function(){
	$.ajax({
        ...
        url:   '/~brojas/director/horario/'+$("#horario_id")+'/edit',
        type:  'get',
        dataType: 'json',
