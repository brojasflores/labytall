...
@endif
<h1>Cursos</h1>
<form role="form" method="get" action="{{ route('director.curso.create')}}">
          ...
          <div class="box-body">
            <table id="example1" class="table table-bordered table-striped">
              ...
              <tr data-id="{{ $cur->id }}">
                ...
                <td><a href="{{ route('director.curso.edit',$cur->id)}}"><button type="submit" class="fa fa-edit btn btn-edit"> Editar</button></a></td>
                <td>
                {!! Form::open(['route' => ['director.curso.destroy', $cur->id], 'method' => 'DELETE', 'id' => 'form-delete'])!!}
