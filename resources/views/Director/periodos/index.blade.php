...
@endif
<h1>Períodos</h1>
<form role="form" method="get" action="{{ route('director.periodo.create')}}">
          ...
          <div class="box-body">
            <table id="example1" class="table table-bordered table-striped">
              ...
              <tr data-id="{{ $per->id }}">
                ...
                <td><a href="{{ route('director.periodo.edit',$per->id)}}"><button type="submit" class="fa fa-edit btn btn-edit"> Editar</button></a></td>
                <td>
                {!! Form::open(['route' => ['director.periodo.destroy', $per->id], 'method' => 'DELETE', 'id' => 'form-delete'])!!}
