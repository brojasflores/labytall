...
@stop
@section('opcion')
<li><a href="{{ route('director.horarioAlumno.index')}}"><i class="fa fa-clock-o"></i> Horarios Alumnos</a></li>
...
{!! Form::model($horarios,['route' => ['director.horarioAlumno.update',$horarios], 'method' => 'PUT']) !!}
