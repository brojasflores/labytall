...
<ul class="sidebar-menu">
            ...
            <li class="treeview">
              ...
              <ul class="treeview-menu">
                <li><a href="{{ route('docente.orario.index')}}"><i class="fa fa-eye"></i> Ver horarios</a></li>
...
@stop
@section('opcion')
<li><a href="{{ route('docente.periodo.index')}}"><i class="fa fa-clock-o"></i> Períodos</a></li>
<li class="active">Agregar Períodos</li>
@stop
@section('content')
<h1>Agregar Período</h1>
<form role="form" method="post" action="{{ route('docente.periodo.store')}}">
