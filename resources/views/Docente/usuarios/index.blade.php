...
@section('content')
<h1>Usuarios</h1>
<form role="form" method="get" action="{{ route('docente.usuario.create')}}">
        ...
        <div class="box-body">
          ...
          <!--foreach recorre una coleccion de objetos-->
              ...
              <tr data-id="{{ $usr->id }}">
                ...
                <td><a href="{{ route('docente.usuario.edit',$usr->id)}}"><button type="submit" class="fa fa-edit btn btn-edit"> Editar</button></a></td>
                <!--<td><a href="{{ route('usuario.edit',$usr->id)}}"><i class="fa fa-edit"></i></a></td>-->
                <td>
                {!! Form::open(['route' => ['docente.usuario.destroy', $usr->id], 'method' => 'DELETE', 'id' => 'form-delete'])!!}
