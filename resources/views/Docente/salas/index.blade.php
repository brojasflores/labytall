...
@section('content')
<h1>Salas</h1>
<form role="form" method="get" action="{{ route('docente.sala.create')}}">
        ...
        <div class="box-body">
          ...
          <!--foreach recorre una coleccion de objetos-->
              ...
              <tr data-id="{{ $sa->id }}">
                ...
                <td><a href="{{ route('docente.sala.edit',$sa->id)}}"><button type="submit" class="fa fa-edit btn btn-edit"> Editar</button></a></td>
                <td>
                {!! Form::open(['route' => ['docente.sala.destroy', $sa->id], 'method' => 'DELETE', 'id' => 'form-delete'])!!}
