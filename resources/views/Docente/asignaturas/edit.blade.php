...
@stop
@section('opcion')
<li><a href="{{ route('docente.asignatura.index')}}"><i class="fa fa-pencil-square-o"></i> Asignaturas</a></li>
...
{!! Form::model($asignaturas,['route' => ['docente.asignatura.update',$asignaturas], 'method' => 'PUT']) !!}
