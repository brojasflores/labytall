...
@stop
@section('opcion')
<li><a href="{{ route('funcionario.autentica.index')}}"><i class="fa fa-clock-o"></i> Asistencia</a></li>
...
{!! Form::model($horarios,['route' => ['funcionario.autentica.update',$horarios], 'method' => 'PUT']) !!}
