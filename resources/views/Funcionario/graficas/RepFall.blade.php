...
<script type="text/javascript">
  ...
  function column_chart(tipo,fecha_inicio,fecha_termino,lab){
    ...
    $.getJSON("{{ route('funcionario.reportes.repfalla') }}",{tipo: tipo,fecha_inicio: fecha_inicio, fecha_termino: fecha_termino, lab:lab}, function(json) {
  ...
  function daño(tipo,lab){
    ...
    $.getJSON("{{ route('funcionario.reportes.repfalla') }}",{tipo: tipo, lab:lab}, function(json) {
