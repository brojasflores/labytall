          ...
          <div class="box-body">
            <table id="example1" class="table table-bordered table-striped">
              ...
              <tr data-id="{{ $de->id }}">
                ...
                <td><a href="{{ route('administrador.departamento.edit',$de->id)}}"><button type="submit" class="fa fa-edit btn btn-edit"> Editar</button></a></td>
                <td>
                {!! Form::open(['route' => ['administrador.departamento.destroy', $de->id], 'method' => 'DELETE', 'id' => 'form-delete'])!!}
