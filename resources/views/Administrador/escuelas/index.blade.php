...
@section('content')
<h1>Escuelas</h1>
<form role="form" method="get" action="{{ route('administrador.escuela.create')}}">
          ...
          <div class="box-body">
            <table id="example1" class="table table-bordered table-striped">
              ...
              <tr data-id="{{ $es->id }}">
                ...
                <td><a href="{{ route('administrador.escuela.edit',$es->id)}}"><button type="submit" class="fa fa-edit btn btn-edit"> Editar</button></a></td>
                <td>
                {!! Form::open(['route' => ['administrador.escuela.destroy', $es->id], 'method' => 'DELETE', 'id' => 'form-delete'])!!}
