...
@endif
<h1>Campus</h1>
<form role="form" method="get" action="{{ route('administrador.campus.create')}}">
          ...
          <div class="box-body">
            <table id="example1" class="table table-bordered table-striped">
              ...
              <tr data-id="{{ $ca->id }}">
                ...
                <td><a href="{{ route('administrador.campus.edit',$ca->id)}}"><button type="submit" class="fa fa-edit btn btn-edit"> Editar</button></a></td>
                <td>
                {!! Form::open(['route' => ['administrador.campus.destroy', $ca->id], 'method' => 'DELETE', 'id' => 'form-delete'])!!}
