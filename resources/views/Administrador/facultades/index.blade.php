...
@section('content')
<h1>Facultad</h1>
<form role="form" method="get" action="{{ route('administrador.facultad.create')}}">
          ...
          <div class="box-body">
            <table id="example1" class="table table-bordered table-striped">
              ...
              <tr data-id="{{ $fac->id }}">
                ...
                <td><a href="{{ route('administrador.facultad.edit',$fac->id)}}"><button type="submit" class="fa fa-edit btn btn-edit"> Editar</button></a></td>
                <td>
                {!! Form::open(['route' => ['administrador.facultad.destroy', $fac->id], 'method' => 'DELETE', 'id' => 'form-delete'])!!}
