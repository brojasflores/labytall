...
@stop
@section('opcion')
<li><a href="{{ route('administrador.autentica.index')}}"><i class="fa fa-clock-o"></i> Asistencia</a></li>
...
{!! Form::model($horarios,['route' => ['administrador.autentica.update',$horarios], 'method' => 'PUT']) !!}
