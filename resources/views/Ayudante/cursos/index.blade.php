...
<ul class="sidebar-menu">
            ...
            <li class="treeview">
              ...
              <ul class="treeview-menu">
                ...
                <li><a href="{{ route('ayudante.ayudante.asignar.index')}}"><i class="fa fa-check-square-o"></i> Reservar</a></li>
              </ul>
            </li>
            <li class="treeview">
              <a href="#">
...
@section('content')
<h1>Cursos</h1>
<form role="form" method="get" action="{{ route('ayudante.curso.create')}}">
        ...
        <div class="box-body">
          ...
          <!--foreach recorre una coleccion de objetos-->
              ...
              <tr data-id="{{ $cur->id }}">
                ...
                <td><a href="{{ route('ayudante.curso.edit',$cur->id)}}"><button type="submit" class="fa fa-edit btn btn-edit"> Editar</button></a></td>
                <td>
                {!! Form::open(['route' => ['ayudante.curso.destroy', $cur->id], 'method' => 'DELETE', 'id' => 'form-delete'])!!}
