          ...
          <div class="box-body">
            <table id="example1" class="table table-bordered table-striped">
              ...
              <tr data-id="{{ $hr->id }}">
                ...
                <td><a href="{{ route('ayudante.MihorarioAyudante.edit',$hr->id)}}"><button type="submit" class="fa fa-edit btn btn-edit"> Editar</button></a></td>
                <td>
                {!! Form::open(['route' => ['ayudante.MihorarioAyudante.destroy', $hr->id], 'method' => 'DELETE', 'id' => 'form-delete'])!!}
