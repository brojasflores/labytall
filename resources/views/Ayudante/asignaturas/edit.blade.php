...
@stop
@section('opcion')
<li><a href="{{ route('ayudante.asignatura.index')}}"><i class="fa fa-pencil-square-o"></i> Asignaturas</a></li>
...
{!! Form::model($asignaturas,['route' => ['ayudante.asignatura.update',$asignaturas], 'method' => 'PUT']) !!}
