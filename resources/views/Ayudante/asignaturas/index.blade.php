...
@section('content')
<h1>Asignaturas</h1>
<form role="form" method="get" action="{{ route('ayudante.asignatura.create')}}">
        ...
        <div class="box-body">
          ...
          <!--foreach recorre una coleccion de objetos-->
              ...
              <tr data-id="{{ $as->id }}">
                ...
                <td><a href="{{ route('ayudante.asignatura.edit',$as->id)}}"><button type="submit" class="fa fa-edit btn btn-edit"> Editar</button></a></td>
                <td>
                {!! Form::open(['route' => ['ayudante.asignatura.destroy', $as->id], 'method' => 'DELETE', 'id' => 'form-delete'])!!}
