...
@section('content')
<h1>Salas</h1>
<form role="form" method="get" action="{{ route('ayudante.sala.create')}}">
        ...
        <div class="box-body">
          ...
          <!--foreach recorre una coleccion de objetos-->
              ...
              <tr data-id="{{ $sa->id }}">
                ...
                <td><a href="{{ route('ayudante.sala.edit',$sa->id)}}"><button type="submit" class="fa fa-edit btn btn-edit"> Editar</button></a></td>
                <td>
                {!! Form::open(['route' => ['ayudante.sala.destroy', $sa->id], 'method' => 'DELETE', 'id' => 'form-delete'])!!}
