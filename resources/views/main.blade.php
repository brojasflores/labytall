    ...
    <div class="wrapper">
              ...
              <li class="dropdown user user-menu">
                ...
                <ul class="dropdown-menu">
                  ...
                  <li class="user-header">
                    ...
                    <img src="{{ asset(Auth::user()-> perfiles) }}" class="img-circle" alt="User Image">
                    <p>
                      {{ Auth::user()->nombres }} - En línea
                    </p>
                  </li>
      ...
      <aside class="main-sidebar">
        ...
        <section class="sidebar">
          ...
          <li class="header text-center" style="color:#fff !important; ">PANEL</li>
          <li  style="border-bottom: 1px solid  #367fa9;"></li>
          </ul>
          <!-- /.search form -->
      ...
      <div class="content-wrapper">
        ...
        <section class="content-header">
           @yield('options')  
          <ol class="breadcrumb">          
            <li><a href="/~brojas"><i class="fa fa-dashboard"></i> Inicio</a></li>
            @yield('opcion')
